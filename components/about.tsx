            ...
            <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
                ...
                <div className="flex flex-col my-3">
                    ...
                    <div className="text-sm italic">
                        <p className="text-gray-400">Me at the botanical gardens taking a wedding picture</p>
                    </div>
                </div>
                <div className="mt-3">
                    ...
                    <h3 className="text-2xl font-bold text-gray-900 mt-6">Professional Journey</h3>
                    ...
                    <h3 className="text-2xl font-bold text-gray-900 mt-6">Personal Interests</h3>
                    <p className="text-base text-gray-600 mt-4">
                    ...
                    <h3 className="text-2xl font-bold text-gray-900 mt-6">Passion for Technology</h3>
                    <p className="text-base text-gray-600 mt-4">
